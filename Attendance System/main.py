...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'batmir780@gmail.com' ")
...
def check_haarcascadefile():
    ...
    if exists:
        ...
        mess._show(title='Some file missing', message="Please contact us for help:'batmir780@gmail.com'")
        window.destroy()
